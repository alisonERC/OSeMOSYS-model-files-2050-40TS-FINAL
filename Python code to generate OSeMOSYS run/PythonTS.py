...
#glpsol -m OSeMOSYS_2017_11_08.txt -d DRC_Input_data_West_v3.txt -o South_v3_1.txt 
#NB   set file path to read from and file path to write to

file2 = open(r"/Users/alison/Documents/2022/2021 OSeMOSYS model/East_Sc1.txt","w+")
...
import openpyxl
path="/Users/alison/Documents/2022/2021 OSeMOSYS model/DRC_input_data_East_v350_4_10.xlsx"
...
print("set FUELd :=D3RES D3IND D3OTH ;",file=file2)
print("set FUELe :=D3ELC01 ;",file=file2)
print("set TRAN :=D3PWRTRN ;",file=file2)
